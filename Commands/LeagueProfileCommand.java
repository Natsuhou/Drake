...
import me.Shogatsu.TheDrakeProject.Menus.ProfileMenu;
        ...
        if (!e.getAuthor().isBot() && !e.getAuthor().isFake()) {
            if (e.getArgs().isEmpty()) {
                ...
                final Summoner summoner = Summoner
                        ...
                        .get();
                if (summoner.exists()) {
                    ProfileMenu profileMenu = new ProfileMenu(e.getAuthor());
                    e.reply(profileMenu.displayProfile(summoner).build());
                } else {
                    ErrorMenu errorMenu = new ErrorMenu(e.getAuthor());
